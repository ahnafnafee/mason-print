...
Releases are manual. Run the **Release** workflow from the Actions tab, give it a semver version, and optionally some notes to sit above the generated commit list.
